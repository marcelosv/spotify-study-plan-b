package com.marcelsouzav.spotify.music.upload.api.service;
...
public class UploadMusicService {
    ...
    public void execute(MusicUploadJson musicUploadJson) throws IOException {
        ProducerRecord<String, byte[]> producerRecord = new ProducerRecord<String, byte[]>(requestTopic, musicUploadJson.getFile().getBytes());
