package com.marcelsouzav.spotify.music.upload.api.config;
...
public class KafkaConfig {
    ...
    /*@Bean
    public ReplyingKafkaTemplate<String, byte[], byte[]> replyKafkaTemplate(ProducerFactory<String, byte[]> pf, KafkaMessageListenerContainer<String, byte[]> container) {
    ...
    /*@Bean
    public KafkaMessageListenerContainer<String, MusicUploadJson> replyContainer(ConsumerFactory<String, MusicUploadJson> cf) {
    ...
    public ConsumerFactory<byte[],byte[]> consumerFactory() {
        return new DefaultKafkaConsumerFactory<>(consumerConfigs(), new ByteArrayDeserializer(), new ByteArrayDeserializer<>());
    }*/
