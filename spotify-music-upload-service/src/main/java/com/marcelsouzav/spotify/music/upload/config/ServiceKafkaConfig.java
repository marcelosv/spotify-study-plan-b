package com.marcelsouzav.spotify.music.upload.config;
...
public class ServiceKafkaConfig {
    ...
    @Bean("templateUpdate")
    public KafkaTemplate<String, MusicJson> kafkaTemplateUpdate() {
        ...
        ProducerFactory factory = new DefaultKafkaProducerFactory(props, new JsonSerializer(), new JsonSerializer());
